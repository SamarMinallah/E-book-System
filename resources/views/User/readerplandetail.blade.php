...
<head>
  ...
  <title>Reader Plan — Online E-Book System</title>
...
<div class="page">
  ...
  <header class="hero2">
    <div class="hero2-top">
      ...
      <span class="plan-badge">Reader Plan</span>
    </div>
  ...
  <!-- ── PLAN DETAIL CARD ── -->
  <div class="detail-card" role="region" aria-label="Reader plan details">

    <!-- Card header -->
    <div class="card-header">
      <div class="card-header-left">
        <span class="card-header-label">Membership Overview</span>
        <span class="card-header-title">Reader Subscription</span>
      </div>
...
<input type="hidden" name="user_id" value="{{ auth()->id() }}">
        <div class="order-row">
          <span>Plan</span>
        <input type="hidden" name="plan_name" value="Reader">
<input type="text" value="Reader" readonly>
        </div>
        <div class="order-row">
          <span>Duration</span>
           <input type="hidden" name="plan_duration" value="1 year">
<input type="text" value="1 year" readonly>
        </div>
        <div class="order-row">
        ...
        <div class="order-total-row">
         ...
         <input type="hidden" name="plan_amount" value="29">
<input type="text" value="$29" readonly>
    ...
    <div class="modal-success" id="modal-success" aria-live="polite">
      ...
      <h3 class="success-title">You're a Reader!</h3>
      <p class="success-sub">
        Your Reader Plan is now active. A confirmation has been sent to your email address.
      </p>
