...
<head>
  ...
  <title>Luminary — Online E-Book System</title>
...
<div class="page">
  ...
  <header class="hero2">
    <div class="hero2-top">
      ...
      <span class="plan-badge">Luminary</span>
    </div>
  ...
  <!-- ── PLAN DETAIL CARD ── -->
  <div class="detail-card" role="region" aria-label="Luminary details">

    <!-- Card header -->
    <div class="card-header">
      <div class="card-header-left">
        <span class="card-header-label">Membership Overview</span>
        <span class="card-header-title">Luminary Subscription</span>
      </div>
    ...
    <div class="card-body">
      ...
      <ul class="features-grid" aria-label="Plan features">
        ...
        <li class="feature-item">
          <span class="feature-dot" aria-hidden="true"></span>
          Shipping fee waiver on 1st order
        </li>
      </ul>
...
<input type="hidden" name="user_id" value="{{ auth()->id() }}">
        <div class="order-row">
          <span>Plan</span>
        <input type="hidden" name="plan_name" value="Luminary">
<input type="text" value="Luminary" readonly>
        </div>
        <div class="order-row">
          <span>Duration</span>
           <input type="hidden" name="plan_duration" value="3 years">
<input type="text" value="3 years" readonly>
        </div>
        <div class="order-row">
        ...
        <div class="order-total-row">
         ...
         <input type="hidden" name="plan_amount" value="69">
<input type="text" value="$69" readonly>
        </div>
      </div><!-- /.order-summary -->
    ...
    <div class="modal-success" id="modal-success" aria-live="polite">
      ...
      <h3 class="success-title">You're a Luminary!</h3>
      <p class="success-sub">
        Your Luminary is now active. A confirmation has been sent to your email address.
      </p>
